"""
Gradient Mode Configuration and Validation Tests
...
Run with: pytest xengym/mpm/tests/test_gradient_mode.py -v
...
def configure_gradient_mode(use_numerical: bool = True, eps: float = 1e-4,
    ...
    """Configure gradient computation mode"""
    ...
    if not use_numerical:
        warnings.warn(
            "Analytical g_F mode enabled. This is INCOMPLETE (missing F @ dS/dF term) "
