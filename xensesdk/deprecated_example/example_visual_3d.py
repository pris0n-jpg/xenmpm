...
import numpy as np
from xensesdk.ezgl.utils.QtTools import VisualizeWidget
...
class InferView(GLViewWidget):
    ...
    # @profile
    def onTimeout(self):
        [src_img, depth_map, diff_img] = self.img_cap.selectSensorInfo(Sensor.OutputType.Rectify, Sensor.OutputType.Depth ,Sensor.OutputType.Difference)
